...
import Maroon5_sugar from "../pages/Maroon5_sugar/Maroon5_sugar"
import Maroon5_one_more_night from "../pages/Maroon5_one_more_night/Maroon5_one_more_night"
import Maroon5_animals from "../pages/Maroon5_animals/Maroon5_animals"
      ...
      <Router history={history} title={title} >
        ...
        >
          ...
          <List>
            ...
            {/* About menu item */}
            <ListItem button component={Link} to="/maroon5_sugar" onClick={onItemClick('Maroon5_sugar')}>
              <ListItemIcon>
                <DashboardIcon />
              </ListItemIcon>
              <ListItemText primary="Maroon5_sugar" />
              { title === 'Maroon5_sugar' && 
                <ListItemIcon>
                  <IconButton onClick={handleDrawerCollapsed}>
                    <ChevronLeftIcon />
            ...
            {/* About menu item */}
            <ListItem button component={Link} to="/maroon5_one_more_night" onClick={onItemClick('Maroon5_one_more_night')}>
              <ListItemIcon>
                <DashboardIcon />
              </ListItemIcon>
              <ListItemText primary="Maroon5_one_more_night" />
              { title === 'Maroon5_one_more_night' && 
                <ListItemIcon>
                  <IconButton onClick={handleDrawerCollapsed}>
                    <ChevronLeftIcon />
                  </IconButton>
            ...
            {/* About menu item */}
             <ListItem button component={Link} to="/maroon5_animals" onClick={onItemClick('Maroon5_animals')}>
              <ListItemIcon>
                <DashboardIcon />
              </ListItemIcon>
              <ListItemText primary="Maroon5_animals" />
              { title === 'Maroon5_animals' && 
                <ListItemIcon>
                  <IconButton onClick={handleDrawerCollapsed}>
                    <ChevronLeftIcon />
                  </IconButton>
        ...
        <main className={classes.content}>
          ...
          <Route path="/maroon5_sugar" component={Maroon5_sugar} />
          <Route path="/Maroon5_one_more_night" component={Maroon5_one_more_night}/>
          <Route path="/Maroon5_animals" component={Maroon5_animals}/>
        </main>
      </Router>
